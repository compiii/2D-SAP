#ifndef PARTITIONING_4R_H
#define PARTITIONING_4R_H
#include "datatype.h"
    ...
    private:
        ...
        void update_bound_block(const int &rank)
        {
            ...
            while (id < max_block)
            {
                ...
                tab_block_data[id].core_data.first_bound.begin = 0 + offset - (offset == 0 ? 0 : 1);
                ...
                tab_block_data[id].core_data.second_bound.begin = 0 + offset - (offset == 0 ? 0 : 1);
